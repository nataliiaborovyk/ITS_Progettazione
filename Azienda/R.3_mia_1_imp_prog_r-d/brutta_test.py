...
from brutta_classi_Dip_Imp_crea_link import *
from datetime import date, timedelta
from brutta_classi_Dip_Imp_crea_link import _imp_prog
...
imp_prog.update(pegaso.get_coinvolti_impiegati())
imp_prog.update(phoenix.get_coinvolti_impiegati())
print(imp_prog)
...
carlo: Impiegato = Impiegato("Carlo", "Colletti",
                              nascita=date.today() - timedelta(weeks=52 * 65),
                              stipendio=Importo(45000) )
carlo.add_progetto(pegaso,oggi)
print(carlo in pegaso)
carlo.remove_progetto(pegaso)
print(carlo in pegaso)
pegaso.add_impiegato(carlo, oggi)
print(pegaso in carlo)
pegaso.remove_impiegato(carlo)
print(pegaso in carlo)
