...
a1.crea_link_aerop_citta(milano)
print(a1)
...
# stampo situazione prima del cambio
print("Prima del cambio:")
print(f"Milano: {milano}")
print(f"Italia: {italia}")
print(f"Germania (ex-Francia): {francia}")

# cambio nazione
milano.crea_link_cit_naz(francia)  # francia ora si chiama Germania

# stampo situazione dopo il cambio
print("\nDopo il cambio:")
print(f"Milano: {milano}")
print(f"Italia: {italia}")
print(f"Germania (ex-Francia): {francia}")
